...
public class SecurityBasket implements LinearState {
    ...
    public SecurityBasket(String basketIpfsHash, AbstractParty lender, AbstractParty borrower, UniqueIdentifier linearId) {
    ...
    public SecurityBasket(String basketIpfsHash, AbstractParty lender, AbstractParty borrower) {
        this.basketIpfsHash = basketIpfsHash;
        this.lender = lender;
        this.borrower = borrower;
