...
public class IouEtfFlow {
	...
	public static class Initiator extends EtfBaseFlow {
		...
		public SignedTransaction call() throws FlowException {
			...
			final PublicKey ourSigningKey = exchangeTradedFund.getOwner()
					.getOwningKey();
			...
			final TransactionBuilder utx =
					new TransactionBuilder(getFirstNotary())
							.addOutputState(exchangeTradedFund, ETFContract
									.ETF_CONTRACT_ID)
							.addCommand(new ETFContract.Commands.Iou(),
									requiredSigners)
			...
			return subFlow(new FinalityFlow(stx, recordTransactions, FINALISING
	...
	@InitiatedBy(IouEtfFlow.Initiator.class)
