    ...
    public static class Initiator extends EtfBaseFlow {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            final TransactionBuilder utx = new TransactionBuilder(getFirstNotary())
                    ...
                    .addCommand(new SecurityBasketContract.Commands.Iou(), requiredSigners)
            ...
            return subFlow(new FinalityFlow(stx, recordTransactions, FINALISING.childProgressTracker()));
        }
